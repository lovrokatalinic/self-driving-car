...
class BehaviouralPlanner:
    ...
    def get_goal_index(self, waypoints, ego_state, closest_len, closest_index):
        ...
        while wp_index < len(waypoints) - 1 and arc_length < self._lookahead:
            wp_index += 1
            arc_length += get_euclidian_distance(ego_state[0], ego_state[1], waypoints[wp_index][0], waypoints[wp_index][1])
        # ------------------------------------------------------------------
...
def get_euclidian_distance(x1, y1, x2, y2):
    distance_x = x1 - x2
    distance_y = y1 - y2
    points_distance = np.sqrt(distance_x**2 + distance_y**2)
...
def get_closest_index(waypoints, ego_state):
    ...
    for i in range(len(waypoints)):
        waypoint_len = get_euclidian_distance(ego_state[0], ego_state[1], waypoints[i][0], waypoints[i][1])
